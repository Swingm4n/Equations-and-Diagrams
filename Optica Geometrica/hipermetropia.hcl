# java -jar drawj2d.jar -T screen -W 103 -H 330 hipermetropia.hcl
# java -jar drawj2d.jar -T rmn -W 330 -H 330 hipermetropia.hcl

font TeX 4
offset [expr 103/2] 5

set E1 {-50 50}; set E2 {50 50}; set CO {0 50}; set CR 25; set R1 {-40 40}; set R2 {-40 60}; set L {-35 50}; set OR {45 50}
...
set R [geom.intersectcircleline $CO $CR $E2 $E1]; m $R; mr +10 0; set I [here]
...
l [geom.intersect $V1 $V2 $OR [geom.intersect $R1 $W1 $L1 $L2]] $R; l [geom.intersect $V1 $V2 $OR [geom.intersect $R2 $W2 $L1 $L2]]
